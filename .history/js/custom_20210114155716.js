...
function BeginFunction(){
    ...
    let building1 = document.getElementById("input1").value )
    let building2 = document.getElementById("input2").value )
    let building3 = document.getElementById("input3").value )
    let building4 = document.getElementById("input4").value )
    let building5 = document.getElementById("input5").value )
