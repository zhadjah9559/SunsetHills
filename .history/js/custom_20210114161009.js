...
function BeginFunction(){
    ...
    let building1 = parsedocument.getElementById("input1")
    let building2 = parsedocument.getElementById("input2")
    let building3 = parsedocument.getElementById("input3")
    let building4 = parsedocument.getElementById("input4")
    let building5 = parsedocument.getElementById("input5")
